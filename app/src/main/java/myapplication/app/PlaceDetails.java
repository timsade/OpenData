...
public class PlaceDetails extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(extras != null){
            name_place.setText((String) extras.get("TAG_NAME"));
            desc_place.setText((String) extras.get("TAG_DESC"));
            address_place.setText((String) extras.get("TAG_ADDRESS"));
            tag_place.setText((String) extras.get("TAG_TAG"));
        }
    }
